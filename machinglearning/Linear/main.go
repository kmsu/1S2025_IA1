...
import (
	...
	ml "github.com/snugml/go" // Importa el paquete ml donde está la lógica de LinearRegression
...
func main() {
	...
	y := []float64{400.5, 40.8, 410.9, 425.4, 450.1, 500.5, 575.7, 456.5, 320.1, 221.9}
